          ...
          child: Column(
            ...
            children: [
                ...
                () => Column(
                  children: [
                    Text(
                      ...
                      style:
                          FutTheme.font4.copyWith(fontSize: height * 0.018),
                      maxLines:
              ...
              Container(
                ...
                width: width,
                height: height * 0.06,
                decoration:  BoxDecoration(color:const  Color(0xffDEFD72),borderRadius: BorderRadius.circular(127)),
                child:  Text("REGISTER NOW >>",style: FutTheme.font5.copyWith(color: Colors.black,fontSize: height*0.024),),
              ),
              SizedBox(
                height: height * 0.05,
              ),
